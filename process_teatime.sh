#!/bin/bash
set -e
dataset_path="/home/bieriv/LangSplat/LangSplat/data/lerf_ovs/teatime"
...
cd autoencoder
python train.py --dataset_path $dataset_path --encoder_dims 256 128 64 32 3 --decoder_dims 16 32 64 128 256 256 512 --lr 0.0007 --dataset_name teatime
