#!/bin/bash
set -e
dataset_path="/home/bieriv/LangSplat/LangSplat/datasets/sofa"
dataset_name="sofa"
casename="sofa"
...
for level in 1 2 3
do
    python train.py -s $dataset_path -m output/${casename} --start_checkpoint $dataset_path/$casename/chkpnt30000.pth --feature_level ${level} --sh_degree 0
